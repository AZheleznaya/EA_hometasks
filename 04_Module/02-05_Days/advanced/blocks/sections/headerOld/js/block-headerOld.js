...
const fullscreenMenuModule = $header => {
	...
	* */
	...
	const openMenu = function( event ) {
		...
		const $btn = $( this )
		const $btnTextSpan = $btn.find( '.js-headerOld-btn__text' )
...
const searchModule = $header => {
	const $search = $header.find( '.js-headerOld-search' )
	const $searchInput = $search.find( '.js-headerOld-search__input' )
	const $openSearch = $search.find( '.js-headerOld-search__open' )
	const $searchResults = $header.find( '.js-headerOld-search__result' );
...
const init = function( section ) {
	...
	if ( headerWrap.length )
		headerWrap.addClass('headerOld-wrap')
...
initScript( '.headerOld', 'header', init )
