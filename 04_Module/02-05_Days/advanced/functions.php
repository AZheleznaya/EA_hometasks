...
function hm_frontend_assets(): void {
	...
	wp_enqueue_style( THEME_TEXTDOMAIN . '-test123', 'https://unpkg.com/simplebar@latest/dist/simplebar.css' );
...
function hm_front_enqueue_assets() {
	...
	wp_enqueue_script( THEME_TEXTDOMAIN . '-slim', 'https://cdn.jsdelivr.net/npm/jquery@3.5.1/dist/jquery.slim.min.js', [], false, true );
    wp_enqueue_script( THEME_TEXTDOMAIN . '-popper', 'https://cdn.jsdelivr.net/npm/popper.js@1.16.1/dist/umd/popper.min.js', [], false, true );
    wp_enqueue_script( THEME_TEXTDOMAIN . '-bootstrap', 'https://cdn.jsdelivr.net/npm/bootstrap@4.6.1/dist/js/bootstrap.min.js', [], false, true );

    wp_enqueue_script( THEME_TEXTDOMAIN . '-simplebar', 'https://unpkg.com/simplebar@latest/dist/simplebar.min.js', [], false, true );
